...
| **internal/graph** | `[implemented]` | Graph Service: Connect read/write RPCs, NATS subscriber for event-driven materialization, resource resolver abstraction, proto conversion, tenant-scoped queries and traversals | pkg/graphdb, pkg/vectordb, pkg/natsbus, pkg/authn, pkg/tenant, pkg/telemetry |
